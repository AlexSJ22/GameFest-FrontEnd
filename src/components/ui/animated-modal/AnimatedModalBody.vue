...
const props = defineProps({
  ...
  overlayClass: { type: String, required: false, default: "" },
  ...
  zIndex: { type: Number, required: false, default: 10000 },
  teleportTo: { type: null, required: false, default: "body" },
});
...
watch(
  ...
  async (value) => {
    if (!import.meta.client) return;
    if (value) {
      previousActive.value = document.activeElement || null;
