...
.background-style {
  ...
  --rainbow: repeating-linear-gradient(
      0deg,
      rgba(255, 120, 115, 0.671) calc(var(--step) * 1),
      rgba(255, 236, 95, 0.616) calc(var(--step) * 2),
      rgba(167, 255, 95, 0.575) calc(var(--step) * 3),
      rgba(131, 255, 247, 0.603) calc(var(--step) * 4),
      rgba(120, 147, 255, 0.616) calc(var(--step) * 5),
      rgba(216, 117, 255, 0.555) calc(var(--step) * 6),
      rgba(255, 120, 115, 0.541) calc(var(--step) * 7)
    )
    0% var(--bg-y) / 200% 700% no-repeat;
  --diagonal: repeating-linear-gradient(
      128deg,
      #0e152e 0%,
      hsla(180, 10%, 60%, 0.562) 3.8%,
      hsl(180, 10%, 60%) 4.5%,
      hsl(180, 10%, 60%) 5.2%,
      #0e152e 10%,
      #0e152e 12%
