          ...
          <Transition name="slide-fade" mode="out-in">
            <div :key="isRegistering" class="w-full">
              <div class="mb-6 sm:mb-8 text-center">
                <h2 class="text-3xl sm:text-4xl font-bold font-['Pixelify_Sans'] bg-gradient-to-r from-purple-400 to-pink-500 bg-clip-text text-transparent uppercase tracking-tighter">
                  {{ title }}
                </h2>
              ...
              <form @submit.prevent="handleSubmit" class="space-y-4 sm:space-y-5">
                ...
                <div v-if="errorMessage" class="text-red-500 text-[11px] text-center font-['Poppins'] font-bold bg-red-500/10 py-2 rounded-lg border border-red-500/20">
                  {{ errorMessage }}
                </div>
